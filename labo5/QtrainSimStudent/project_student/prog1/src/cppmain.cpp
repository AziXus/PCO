...
int cmain()
{
    ...
    Parcours parcoursA = Parcours({25, 24, 23, 16, 15, 14, 7, 6, 5, 34, 33, 32}, 32, 23, 5, 34, 16);
    Parcours parcoursB = Parcours({22, 21, 20, 19, 13, 15, 14, 7, 6, 1, 31, 30, 29, 28},  28, 19, 1, 31, 13);
